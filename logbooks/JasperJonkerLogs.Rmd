...
cat /students/2024-2025/Thema05/BlaasKanker/SRR_Acc_List.txt | \
  parallel 'TrimmomaticPE -threads 8 ' \
                  ...
                  'ILLUMINACLIP:/students/2024-2025/Thema05/BlaasKanker/tools/trim_adapters/TruSeq3-PE.fa:2:40:10 ' \
                  'MINLEN:40 ' \
                  'SLIDINGWINDOW:4:20'
```
...
We kunnen het proberen met traling toe te passen. Dit verwijderd de laaste paar basen verwijderd worden totdat een totdat er een kwaliteit gevonden is 
