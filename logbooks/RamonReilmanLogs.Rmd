...
Eigen data base bouwen:

blablabla

gene.gtf en vcf chromosomen komen niet overeen
```{bash, eval=FALSE}
cat /students/2024-2025/Thema05/BlaasKanker/SRR_Acc_List.txt | \
parallel -j 8 \
...
cut -f 1 /path/to/your_file.gtf | sort | uniq

## 02-10-2024

Nieuwe mapping gemaakt voor de header, opnieuw uitvoeren
...
Unkown testing
aanpassing 1 naar un, geef meer CHROMOSOME_Not_found
Dit ontstaat dus door de Un chromosomen.
