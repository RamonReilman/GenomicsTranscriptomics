...
resultaten van tonen. Ik begin met het loggen over Genomics en er zal op
...
werkt en meer over de tool leren. Jasper is begonnen met de tool BWA
voor de mapping van onze data. Kijk voor informatie hierover in het
logboek van Jasper. Te vinden op onze github onder logbooks,
JasperJonkerLogbooks:
...
**2-10-2024** Ramon heeft laten zien dat hij door middel van nog 2
andere tools mijn tool snpEff bijna werkend heeft gekregen. Kijk voor de
stappen die hij heeft ondernomen in zijn logboek: Te vinden op onze
[github](https://github.com/RamonReilman/GenomicsTranscriptomics) onder
logbooks, RamonReilmanLogbooks:\

**3-10-2024** Ik heb afgelopen week feedback gekregen op mijn logboek
van Ronald. Hierbij is gebleken dat ik alles veel duidelijker en
uitgebreider moet verwoorden. Daarom neem ik hier vandaag de tijd voor
om het hele logboek van vooraan tot en met nu volledig aan te vullen.
Hierbij ga ik de hoe, wat en waarom toepassen om op deze manier zoveel
mogelijk tijdsverantwoording te vangen.\
