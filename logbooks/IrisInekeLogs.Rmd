...
## inleiding
In dit logboek zijn alle stappen beschreven die zijn uitgevoerd om van een dataset van een artikel over blaaskanker de variants te vinden.
...
De input komt van Jasper van de mapping. Zie [Jasper zijn logboek](https://github.com/RamonReilman/GenomicsTranscriptomics/blob/main/logbooks/JasperJonkerLogs.Rmd) Voor de 'O' een map maken waar
...
Wat overblijft ws biologische duplicaten. Die willen we behouden.

zijn de statistieken in het artikel ook relevant voor ons ?
...
## Maandag 7 oktober:
Er komt een foutmelding uit de code die aangeeft dat de tabixfiles(index) niet aanwezig zijn. Met behulp van [Ramon zijn logboek](https://github.com/RamonReilman/GenomicsTranscriptomics/blob/main/logbooks/RamonReilmanLogs.Rmd) die files gemaakt.
...
Ramon heeft de plot overgenomen van mij, omdat het mij niet is gelukt. Zie hiervoor [Ramon zijn logboek](https://github.com/RamonReilman/GenomicsTranscriptomics/blob/main/logbooks/RamonReilmanLogs.Rmd).
