...
Wat is het verschil tussen de TCRseq, RNAseq en NGS_RNAseq:
...
- NGS_RNAseq: NGS-muizen zijn muizen die een zwak immuumsysteem hebben en daardoor gebruikt worden om menselijke cellen in te enten (zonder dat het immuumsysteem van de muis ze afstoot).
...
- samples met ngs enzo (tabel leveren aan Ramon)
